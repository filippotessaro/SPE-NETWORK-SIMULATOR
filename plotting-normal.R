...
# Simulation Type
simType <- list('aloha-normal','trivial-normal')
...
#ylim(c(0, 3))
ggsave(paste(res.folder, '/normal-thr_', n.nodes, '.pdf', sep=''), width=16/div, height=9/div)
print(p)
...
#ylim(c(0, 1))
ggsave(paste(res.folder, '/normal-pdr_', n.nodes, '.pdf', sep=''), width=16/div, height=9/div)
print(pdr)
